...
<body class="antialiased">
        ...
        <div>
            ...
            <div class="carousel-inner">
                ...
                <img src="/storage/imagem/foto1.jpeg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="/storage/imagem/foto2.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="/storage/imagem/foto3.jpg" class="d-block w-100" alt="...">
                </div>
            </div>
            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8 col-xl-6 text-center">
                        ...
                        <hr class="divider" />
                        <p class="text-muted mb-5">Deixe seu email que enviaremos pra você novidades para você sempre
                    ...
                    <div class="col-lg-6">
                        <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                            ...
                            <div class="d-grid"><button class="btn btn-primary btn-xl disabled" id="submitButton"
                                    type="submit" onclick='return confirm(\"Deseja Excluir?\")'>Enviar</button></div>
