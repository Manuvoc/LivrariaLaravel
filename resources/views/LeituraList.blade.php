...
<body class="antialiased">
    ...
    <div>
        ...
        <div class="container">
            <h1>Listagem das Leituras {{ request()->id }}</h1>
            <br>
                ...
                <div class="row">
                    <div class="col-2">
                        <select name="campo" class="form-select">
                            ...
                            <option value="hora_leitura">Hora Telefone</option>
                            <option value="valor_sensor">Valor sensor</option>
                            <option value="sensor_id">Sensor id</option>
