...
<body class="antialiased">
    ...
    <div>
        ...
        <div class="container">
            <h1>Listagem de Livros {{ request()->id }}</h1>

            <br>
            <form action="{{ action('App\Http\Controllers\LivrosController@search') }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-2">
                    ...
                    <div class="col-6">
                        ...
                        <a class="btn btn-success"
                            href='{{ action('App\Http\Controllers\LivrosController@create') }}'><i
                ...
                <tbody>
                    @foreach ($livros as $item)
                        ...
                        <tr>
                            ...
                            <td>{{ $item->nome }}</td>
                            <td>{{ $item->valor }}</td>
                            <td>{{ !empty($item->generolivro->nome) ? $item->generolivro->nome : '' }}</td>
